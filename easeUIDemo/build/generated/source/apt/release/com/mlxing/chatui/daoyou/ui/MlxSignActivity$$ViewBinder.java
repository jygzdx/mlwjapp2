...
public class MlxSignActivity$$ViewBinder<T extends MlxSignActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493290, "field 'editPswd2'");
    target.editPswd2 = finder.castView(view, 2131493290, "field 'editPswd2'");
    view = finder.findRequiredView(source, 2131493287, "field 'editCode'");
    target.editCode = finder.castView(view, 2131493287, "field 'editCode'");
    view = finder.findRequiredView(source, 2131493292, "field 'imageSign' and method 'onClick'");
    target.imageSign = finder.castView(view, 2131493292, "field 'imageSign'");
    ...
    view = finder.findRequiredView(source, 2131493288, "field 'btnGetCode' and method 'onClick'");
    target.btnGetCode = finder.castView(view, 2131493288, "field 'btnGetCode'");
    unbinder.view2131493288 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onClick(p0);
  ...
  protected static class InnerUnbinder<T extends MlxSignActivity> implements Unbinder {
    ...
    protected void unbind(T target) {
      ...
      view2131493288.setOnClickListener(null);
