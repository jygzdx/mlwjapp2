...
public class MlxLoginActivity$$ViewBinder<T extends MlxLoginActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131493145, "field 'imgWx' and method 'onClick'");
    target.imgWx = finder.castView(view, 2131493145, "field 'imgWx'");
    ...
    view = finder.findRequiredView(source, 2131493296, "field 'textSign' and method 'onClick'");
    target.textSign = finder.castView(view, 2131493296, "field 'textSign'");
    ...
    view = finder.findRequiredView(source, 2131493297, "field 'textFind' and method 'onClick'");
    target.textFind = finder.castView(view, 2131493297, "field 'textFind'");
