...
public class MlxSignActivity$$ViewBinder<T extends MlxSignActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493300, "field 'editPswd2'");
    target.editPswd2 = finder.castView(view, 2131493300, "field 'editPswd2'");
    view = finder.findRequiredView(source, 2131493297, "field 'editCode'");
    target.editCode = finder.castView(view, 2131493297, "field 'editCode'");
    view = finder.findRequiredView(source, 2131493302, "field 'imageSign' and method 'onClick'");
    target.imageSign = finder.castView(view, 2131493302, "field 'imageSign'");
    ...
    view = finder.findRequiredView(source, 2131493298, "field 'btnGetCode' and method 'onClick'");
    target.btnGetCode = finder.castView(view, 2131493298, "field 'btnGetCode'");
