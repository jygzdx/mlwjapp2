...
public class EaseImageCache {
	...
	private static easeui.model.EaseImageCache imageCache = null;

	public static synchronized easeui.model.EaseImageCache getInstance() {
		if (imageCache == null) {
			imageCache = new easeui.model.EaseImageCache();
		}
		return imageCache;
