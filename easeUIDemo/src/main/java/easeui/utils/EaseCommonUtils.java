...
//              digest = EasyUtils.getAppResourceString(context, "location_prefix");
            ...
            case TXT: // 文本消息
                ...
                if (message.getBooleanAttribute(easeui.EaseConstant.MESSAGE_ATTR_IS_VOICE_CALL,
                        false)) {
                    digest = getString(context, R.string.voice_call) + txtBody.getMessage();
                } else if (message.getBooleanAttribute(easeui.EaseConstant
                        .MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
