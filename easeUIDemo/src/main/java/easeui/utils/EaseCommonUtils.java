...
public class EaseCommonUtils {
	...
	public static EMMessage createExpressionMessage(String toChatUsername, String expressioName, String identityCode){
        ...
        if(identityCode != null){
            message.setAttribute(easeui.EaseConstant.MESSAGE_ATTR_EXPRESSION_ID, identityCode);
        }
        message.setAttribute(easeui.EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, true);
        return message;
	}
...
//              digest = EasyUtils.getAppResourceString(context, "location_prefix");
        ...
        case TXT: // 文本消息
            ...
            }else */if(message.getBooleanAttribute(easeui.EaseConstant.MESSAGE_ATTR_IS_VOICE_CALL, false)){
                digest = getString(context, R.string.voice_call) + txtBody.getMessage();
            }else if(message.getBooleanAttribute(easeui.EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
     ...
     * @param user
     */
    public static void setUserInitialLetter(easeui.domain.EaseUser user) {
