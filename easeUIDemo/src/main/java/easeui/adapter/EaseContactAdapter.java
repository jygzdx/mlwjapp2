...
public class EaseContactAdapter extends ArrayAdapter<easeui.domain.EaseUser> implements SectionIndexer{
    private static final String TAG = "ContactAdapter";
    List<String> list;
    List<easeui.domain.EaseUser> userList;
    List<easeui.domain.EaseUser> copyUserList;
    ...
    public EaseContactAdapter(Context context, int resource, List<easeui.domain.EaseUser> objects) {
        super(context, resource, objects);
        this.res = resource;
        this.userList = objects;
        copyUserList = new ArrayList<easeui.domain.EaseUser>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        easeui.domain.EaseUser user = getItem(position);
        if(user == null)
        ...
        //设置头像
        easeui.utils.EaseUserUtils.setUserNick(username, holder.nameView);
        //设置头像
        easeui.utils.EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar);
    ...
    @Override
    public easeui.domain.EaseUser getItem(int position) {
    ...
    protected class  MyFilter extends Filter{
        List<easeui.domain.EaseUser> mOriginalList = null;
        
        public MyFilter(List<easeui.domain.EaseUser> myList) {
        ...
        protected synchronized FilterResults performFiltering(CharSequence prefix) {
            ...
            if(mOriginalList==null){
                mOriginalList = new ArrayList<easeui.domain.EaseUser>();
            }
            ...
            if(prefix==null || prefix.length()==0){
                ...
                final ArrayList<easeui.domain.EaseUser> newValues = new ArrayList<easeui.domain.EaseUser>();
                for(int i=0;i<count;i++){
                    final easeui.domain.EaseUser user = mOriginalList.get(i);
        ...
        protected synchronized void publishResults(CharSequence constraint,
            ...
            userList.clear();
            userList.addAll((List<easeui.domain.EaseUser>)results.values);
