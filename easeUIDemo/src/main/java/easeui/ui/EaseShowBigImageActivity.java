...
import easeui.utils.ActivityManager;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityManager.getInstance().addPicActivity(this);
...
//				image.setMinScale(0.9f);
//				image.setMaxScale(10.0f);
...
//                bitmap= BitmapFactory.decodeFile(localFilePath,opt);
