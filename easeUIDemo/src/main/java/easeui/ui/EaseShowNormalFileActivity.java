                ...
                new EMCallBack() {
                    ...
                    public void onSuccess() {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                FileUtils.openFile(file,easeui.ui.EaseShowNormalFileActivity.this);
                                finish();
                            }
                        });
                    }
                    ...
                    public void onError(int error, final String msg) {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                Toast.makeText(easeui.ui.EaseShowNormalFileActivity.this, str4+msg, Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        });
                    }
