...
public class ImgFileListAdapter extends BaseAdapter{
	...
	easeui.choisepictures.Util util;
	Bitmap[] bitmaps;
	private int index=-1;
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg0 != index && arg0 > index) {
			holder=new Holder();
			arg1=LayoutInflater.from(context).inflate(R.layout.mlx_imgfileadapter, null);
...
//		}
		Glide.with(context).load(listdata.get(arg0).get(imgpath)).crossFade().centerCrop().into(holder.photo_imgview);
