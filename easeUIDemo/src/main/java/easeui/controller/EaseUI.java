...
public final class EaseUI {
    private static final String TAG = easeui.controller.EaseUI.class.getSimpleName();

    /**
     * the global EaseUI instance
     */
    private static easeui.controller.EaseUI instance = null;
     ...
     * @return
     */
    public synchronized static easeui.controller.EaseUI getInstance(){
        if(instance == null){
            instance = new easeui.controller.EaseUI();
        }
        return instance;
    }
