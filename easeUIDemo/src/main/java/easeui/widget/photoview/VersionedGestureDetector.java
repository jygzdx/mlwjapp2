...
abstract class VersionedGestureDetector {
	...
	public static easeui.widget.photoview.VersionedGestureDetector newInstance(Context context, OnGestureListener listener) {
		final int sdkVersion = Build.VERSION.SDK_INT;
		easeui.widget.photoview.VersionedGestureDetector detector = null;
	...
	private static class CupcakeDetector extends easeui.widget.photoview.VersionedGestureDetector {
