...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(easeui.widget.photoview.PhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(easeui.widget.photoview.PhotoViewAttacher.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(easeui.widget.photoview.PhotoViewAttacher.OnViewTapListener listener);
