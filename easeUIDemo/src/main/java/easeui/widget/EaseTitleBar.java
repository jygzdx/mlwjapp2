...
public class EaseTitleBar extends RelativeLayout{
    ...
    protected TextView titleView,leftText,rightDot;
    ...
    public void setLeftTextVisiable(int visibility){
    leftText.setVisibility(visibility);
}
    public void setRightDotVisiable(int visibility){
    rightDot.setVisibility(visibility);
}
