...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (msg != null) {
			...
			asyncFetchUserInfo(msg.getFrom(),holder);
	...
	public void asyncFetchUserInfo(final String username, final ViewHolder holder){
		...
		/*HttpUtil.getInstance().getUserInfo(username, new HttpUtil.InfoCallBack() {
			...
			public void onSuccess(List<EaseUser> result) {
				...
				if (user != null) {
					...
					EaseUserUtils.setUserAvatar(getContext().getApplicationContext(), username, holder.avator);
				}
			}
		});*/
