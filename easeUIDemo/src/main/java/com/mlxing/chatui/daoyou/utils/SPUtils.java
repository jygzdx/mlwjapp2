...
public class SPUtils {
    ...
    public static String SP_UNIONID="unionid";
    public static String SP_QRCODE="qrcode";
     ...
     * 是否隐藏小点点
     */
    public static String SP_DOT="dot";
    public static String isDot="yes";
    public static String noDot="no";
