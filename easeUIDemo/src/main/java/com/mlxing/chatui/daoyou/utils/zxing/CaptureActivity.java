...
import com.mlxing.chatui.daoyou.utils.zxing.camera.CameraManager;
import com.mlxing.chatui.daoyou.utils.zxing.decode.CaptureActivityHandler;
import com.mlxing.chatui.daoyou.utils.zxing.decode.InactivityTimer;
import com.mlxing.chatui.daoyou.utils.zxing.decode.RGBLuminanceSource;
import com.mlxing.chatui.daoyou.utils.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mlx_activity_capture);
	...
	private void onResultHandler(String resultString, Bitmap bitmap) {
		if (TextUtils.isEmpty(resultString)) {
			Toast.makeText(this, "抱歉,扫描失败!", Toast.LENGTH_SHORT).show();
			return;
		}

        SPUtils.put(this, SPUtils.SP_URL, resultString);

//        String id = resultString.substring(resultString.lastIndexOf("=") + 1);
//        if(isInGroup(id)){
//            Intent intent = new Intent(CaptureActivity.this, ChatActivity.class);
//            // it is group chat
...
//            finish();
//        }else{
//            UIHelper.goToWebView(CaptureActivity.this, resultString);
//            finish();
//        }
        Intent i = new Intent();
        i.putExtra("qr",resultString);
		setResult(WebkitActivity.QRCODE_RESULT,i);

        finish();
//        if (resultString.contains("weixin.mlxing.com/wrq/joinGroup")){
//			//进入群聊
//			Intent intent = new Intent(CaptureActivity.this, ChatActivity.class);
//			String u = resultString.substring(resultString.lastIndexOf("=") + 1);
//			intent.putExtra("userId", u);
//			intent.putExtra("chatType", com.mlxing.chatui.Constant.CHATTYPE_GROUP);
//			startActivity(intent);
//			finish();
//		}
//        else if (resultString.contains("mlxing.chat")){
//			//进入单聊
//			Intent intent = new Intent(CaptureActivity.this, ChatActivity.class);
