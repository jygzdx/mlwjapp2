...
public class UserDao {
	...
	public static final String STRANGER_NAME_ID ="username";
	public static final String STRANGER_NAME_NICK ="nick";
	public static final String STRANGER_NAME_AVATAR ="avatar";
	...
	public Map<String, EaseUser> getStrangerList() {
		...
		return DemoDBManager.getInstance().getStrangerList();
	}
	/**
	 * 保存陌生人list
	 *
	 * @return
	 */
	public void saveStrangerList(List<EaseUser> list) {

		 DemoDBManager.getInstance().saveStrangerList(list);
	}
