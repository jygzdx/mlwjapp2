...
public class DbOpenHelper extends SQLiteOpenHelper{
	...
	private static final String STRANGERS_TABLE_CREAT="CREATE TABLE "
			+ UserDao.STRANGER_TABLE_NAME + " ("
			+ UserDao.STRANGER_NAME_NICK + " TEXT, "
			+ UserDao.STRANGER_NAME_AVATAR + " TEXT, "
			+ UserDao.STRANGER_NAME_ID + " TEXT PRIMARY KEY);";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(STRANGERS_TABLE_CREAT);
